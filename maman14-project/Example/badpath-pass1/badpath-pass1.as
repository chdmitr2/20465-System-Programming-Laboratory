...
; 40. undefined directive (case sensitivity)
        .DATA   5

; 41. This line is ok (it is ok to designate the same entry more than once)
        .entry  DATA1

; 42. invalid characters (blabla is not a string)
        .string blabla

; 43. invalid characters (blabla)
        .string "abcdefg" blabla

; 44. this line is ok (comma within string is not a separator)
STR1:   .string "abc, ,defg"

; 45. invalid label (too long)
SuperCalifragilisticExpiAlidocious: .data	4	
          
; 46. missing argument in directive
        .data

; 47. missing argument in directive
        .entry

; 48. undefined directive
        .invalid 85,90

; 49. this line is ok
        rts

; 50. invalid characters (Next)
        rts Next
